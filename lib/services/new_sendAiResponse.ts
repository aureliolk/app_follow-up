...
export async function sendAIResponse({ aiResponse, newMessageId ,workspaceId }: SendAIResponseParams) {
    ...
    aiResponse = await generateAIResponse(aiResponse, conversation.workspace);
