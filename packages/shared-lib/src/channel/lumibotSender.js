...
exports.enviarTextoLivreLumibot = enviarTextoLivreLumibot;
// lib/channel/lumibotSender.ts
const axios_1 = __importDefault(require("axios"));
// Função auxiliar de envio para Lumibot (Texto Livre)
async function enviarTextoLivreLumibot(accountId, conversationId, // Este é o channel_conversation_id
token, content) {
    var _a, _b;
    ...
    try {
        ...
        if (axios_1.default.isAxiosError(error)) {
            errorMessage = `Erro Axios ${((_a = error.response) === null || _a === void 0 ? void 0 : _a.status) || 'sem status'}: ${error.message}`;
            errorData = ((_b = error.response) === null || _b === void 0 ? void 0 : _b.data) || { detail: error.message };
...
//# sourceMappingURL=lumibotSender.js.map