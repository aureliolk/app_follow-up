...
import { authOptions } from '@/lib/auth/auth-options'; // Ajuste o caminho se necessário
import { checkPermission } from '@/lib/permissions'; // Ajuste o caminho se necessário
