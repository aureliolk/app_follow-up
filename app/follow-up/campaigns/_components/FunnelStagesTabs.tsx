...
import { FunnelStep, FunnelStage } from '@/app/follow-up/_types/schema';
  ...
  const handleSubmitStep = async (data: FunnelStep) => {
    try {
      ...
      toast.success(isEditMode 
        ...
        : 'Estágio adicionado com sucesso'
      );
    } catch (err) {
        ...
        <div className="pr-4 flex items-center">
          {isLoading ? (
            <span className="text-xs text-gray-400 flex items-center">
              <svg className="animate-spin h-4 w-4 mr-1 text-orange-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
