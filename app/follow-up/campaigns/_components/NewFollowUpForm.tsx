...
export const NewFollowUpForm: React.FC<NewFollowUpFormProps> = ({ campaigns, isLoading, onSubmit }) => {
  ...
  return (
    <div className="bg-gray-700 rounded-lg p-4 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-1">Campanha</label>
          <select
            value={campaignId}
