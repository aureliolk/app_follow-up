...
import { FunnelStageFormRHF, FunnelStageFormComponent } from "./index"
import type { FunnelStage, FunnelStep } from "@/app/follow-up/_types/schema"
...
export default function ExampleUsage({ campaignId }: ExampleUsageProps) {
  ...
  const { stages, isLoading: stagesLoading, fetchStages, createStage, updateStage, deleteStage } = useFunnelStages()

  const { steps, isLoading: stepsLoading, fetchSteps, createStep, updateStep, deleteStep } = useFunnelSteps()
