...
import type { FunnelStage } from "@/app/follow-up/_types/schema"
...
const FunnelStageList: React.FC<FunnelStageListProps> = ({ stages, onEdit, onRemove, campaignId, refreshStages }) => {
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-gray-600">
          <thead className="bg-gray-800">
            <tr>
              <th scope="col" className="px-4 py-2 text-left text-xs font-medium text-gray-400">
                Ordem
              </th>
              <th scope="col" className="px-4 py-2 text-left text-xs font-medium text-gray-400">
                Nome
