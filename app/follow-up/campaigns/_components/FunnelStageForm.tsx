  ...
  return (
    <div className="bg-gray-700 p-4 rounded-lg mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div>
          <label className="block text-xs font-medium text-gray-400 mb-1">Nome da Etapa *</label>
          <input
            type="text"
            value={newStage.name}
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => setNewStage({ ...newStage, order: Number.parseInt(e.target.value) })}
            className="w-full px-3 py-2 bg-gray-600 text-white rounded-md border border-gray-500"
            min="1"
          />
        </div>
      ...
      <div className="flex justify-end space-x-3">
        ...
        <button
          ...
          disabled={isLoading}
          className={`px-4 py-2 ${
            editingStage ? "bg-blue-600 hover:bg-blue-700" : "bg-purple-600 hover:bg-purple-700"
